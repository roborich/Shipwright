...
// Every resource type the game reads, binary, XML and (SOH [Unbound]) JSON. Shared with the wasm Unbound converter
// (soh/wasm/convert), which loads the same vanilla resources without the rest of the game.
